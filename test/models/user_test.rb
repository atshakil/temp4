...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    #@user = User.new(name: "Test User", email: "some@email.com")
  ...
  test "name should've reasonable length" do
    @user.name = 'n'*51
    assert_not @user.valid?
  end

  test "email should've reasonable length" do
    @user.email = 'n'*246+'@gmail.com'
    assert_not @user.valid?
  end
